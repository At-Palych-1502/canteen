...
import { useCreateDishMutation } from '@/app/tools/redux/api/dishes';
...
const DishCreateModal: React.FC<DishEditModalProps> = ({
	ingredients,
	onClose,
}) => {
	...
	useEffect(() => {
		setFormData({ id: -1, name: '', weight: 0, ingredients: [] });
